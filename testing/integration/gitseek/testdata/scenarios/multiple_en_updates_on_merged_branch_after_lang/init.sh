...
git add content/en/docs/test.md
GIT_AUTHOR_DATE=$DATE GIT_COMMITTER_DATE=$DATE git commit -m "C: update content/en/docs/test.md on en-branch"

increment_date
echo "D" >> content/en/docs/test.md
git add content/en/docs/test.md
GIT_AUTHOR_DATE=$DATE GIT_COMMITTER_DATE=$DATE git commit -m "D: update content/en/docs/test.md on en-branch again"
